...
echo "Running the following command line:"
echo "python produceBranches.py -i ${input_file} -o ${output_file} -c 100"
python produceBranches.py -i ${input_file} -o ${output_file} -c 100
